...
function calendar(Month, Year) {
  ...
  calendar_html = '<table class = "monthtable" style = "background-color:#EEEEEE; color:ffffff; width: 60%; margin: 0 auto 20px auto; -webkit-box-shadow: 10px 10px 5px #898989;">';
  calendar_html += '<tr style = "border: 2px solid black;"><td colspan = "7" style = "background-color:#1b363f; color:#fff; text-align: center; font-size: 30px;">' + months[month] + ' ' + year + '</td></tr>';
